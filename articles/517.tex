...
\settowidth{\versewidth}{Now in thy dazzling \sfrac{$1$}{$2$}-oped eye,}
\begin{verse}[\versewidth]
\poemlines{5}
Now in thy dazzling \sfrac{$1$}{$2$} oped eye,\footnotetext{`A Mother to Her Waking Infant', Joanna Baillie (1762 -- 1851). \cite{norton}.}\\*
