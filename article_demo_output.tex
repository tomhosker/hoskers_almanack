\footnotetext{Anonymous, \cite{sss}. \textit{SSS} is only the primary source: there are very many versions of this shanty: the Almanackist has done his best to extract the best of each of them.}\begin{center}
